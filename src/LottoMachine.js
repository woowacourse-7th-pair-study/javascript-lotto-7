...
class LottoMachine {
  ...
  #lottos = [];
  #result = {
    1: { count: 0, price: 2000000000 },
    2: { count: 0, price: 30000000 },
    3: { count: 0, price: 1500000 },
    4: { count: 0, price: 50000 },
    5: { count: 0, price: 5000 },
    6: { count: 0, price: 0 },
  };
  ...
  getResultForPrint() {
    return `3개 일치 (5,000원) - ${this.#result[5].count}개
4개 일치 (50,000원) - ${this.#result[4].count}개
5개 일치 (1,500,000원) - ${this.#result[3].count}개
5개 일치, 보너스 볼 일치 (30,000,000원) - ${this.#result[2].count}개
6개 일치 (2,000,000,000원) - ${this.#result[1].count}개`;
  }
